...
if __name__=='__main__':
    ...
    for i in range(num_epochs):
        ...
        model_weights_path = base_dir+'training/model_weights_all_epoch%i_seed%s_batch%i.pt'%(i, seed, batch_size)
    ...
    with open(base_dir+'training/train_loss_all_%iepochs_seed%s_batch%i.npy'%(num_epochs,seed,batch_size), 'wb') as f:
